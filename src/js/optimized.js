            ...
            if(buyingPhase != 1){
                ...
                setTimeout(()=>{
                    ...
                    setTimeout(()=>{
                        ...
                        content.innerHTML = `Bạn có muốn chơi lại không? Chỉ cần đặt một ly Trà Mật Rừng hoặc Phin Sữa Nâu của LUPU bạn sẽ có thêm 1 lượt chơi. Ngoài ra bạn sẽ được LUPU tặng 5k và giảm đến 50% cho ly thứ 2. `;
